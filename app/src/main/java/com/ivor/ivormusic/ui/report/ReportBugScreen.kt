...
/**
 * A fixed-height block of monospace log/report text. Scrollable so a long
 * payload can be read without stretching the card; [newestFirst] keeps the
 * natural log order (oldest at top).
 */
@Composable
