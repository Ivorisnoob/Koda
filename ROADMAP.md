...
The heading above covers getting playlists in and out in formats other apps understand, framed around m3u and a round trip with the other YouTube clients. This is the harder half and it earns its own entry: bringing in a playlist somebody built somewhere else, in Spotify, Apple Music or another YouTube client. It is the most common reason a person opens a new music app and then closes it, because everything they listen to is still in the old one.
